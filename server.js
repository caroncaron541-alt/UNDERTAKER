...
// Serve static frontend files from your public directory (or root folder)
...
/*
  ...
  IMPORTANT:
  Accounts and OTPs will be lost if the server
  restarts. We will add a real database later.
*/
...
/*
  Health check / Frontend fallback route
*/
app.get("/", (req, res) => {
  const indexPath = path.join(__dirname, "public", "index.html");
  res.sendFile(indexPath, (err) => {
    if (err) {
      // Fallback to JSON if index.html isn't found in a public folder yet
      res.json({
        success: true,
